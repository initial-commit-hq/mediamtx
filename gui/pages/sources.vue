    ...
    <div class="page-wrap">
        ...
        <div class="content">
            ...
            <div v-else-if="paths.length === 0" class="empty-state">
                ...
                <p>
                    Add a path to define a camera source or publisher endpoint.
                </p>
                    ...
                    <tbody>
                        <tr v-for="p in paths" :key="p.name">
                            ...
                            <td class="source-cell">
                                <span
                                    class="badge"
                                    :class="`badge-${sourceType(p.source)}`"
                                    >{{ sourceType(p.source) }}</span
                                >
                                <span
                                    v-if="p.source && p.source !== 'publisher'"
                                    class="source-url"
                                    >{{ p.source }}</span
                                >
                            </td>
        ...
        <Teleport to="body">
            ...
            >
                <div class="confirm-dialog">
                    <p>
                        Delete path <strong>{{ deleteTarget }} </strong>?
                    </p>
                    <p class="confirm-sub">
                        This removes it from the configuration immediately.
                    </p>
                    ...
                    <p v-if="deleteError" class="error-msg">
                        {{ deleteError }}
                    </p>
                </div>
            </div>
